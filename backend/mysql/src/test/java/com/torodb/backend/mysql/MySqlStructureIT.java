...
import com.torodb.backend.mysql.meta.MySqlSnapshotUpdaterImpl;
...
public class MySqlStructureIT extends AbstractStructureIntegrationSuite {
  ...
  @Override
  protected SnapshotUpdater getSnapshotUpdater(SqlInterface sqlInterface, SqlHelper sqlHelper, 
      SchemaUpdater schemaUpdater, TableRefFactory tableRefFactory) {
    return new MySqlSnapshotUpdaterImpl(sqlInterface, sqlHelper, schemaUpdater, tableRefFactory);
  }
