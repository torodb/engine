...
public class LongValueConverter implements KvValueConverter<Long, Long, KvLong> {
  ...
  public static final DataType<Long>       BIGINT             = 
      new DefaultDataType<Long>(SQLDialect.MYSQL, SQLDataType.BIGINT, "BIGINT");
  
  public static final DataTypeForKv<KvLong> TYPE = DataTypeForKv.from(
      LongValueConverter.BIGINT, new LongValueConverter());
