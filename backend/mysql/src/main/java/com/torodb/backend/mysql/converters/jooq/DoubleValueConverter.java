...
public class DoubleValueConverter implements KvValueConverter<Double, Double, KvDouble> {
  ...
  public static final DataType<Double>     DOUBLE             = 
      new DefaultDataType<Double>(SQLDialect.MYSQL, SQLDataType.DOUBLE, "DOUBLE");
  
  public static final DataTypeForKv<KvDouble> TYPE = DataTypeForKv.from(
      DoubleValueConverter.DOUBLE, new DoubleValueConverter());
