...
public class IntegerValueConverter implements KvValueConverter<Integer, Integer, KvInteger> {
  ...
  public static final DataType<Integer>    INTEGER            = 
      new DefaultDataType<Integer>(SQLDialect.MYSQL, SQLDataType.INTEGER, "INT");
  
  public static final DataTypeForKv<KvInteger> TYPE = DataTypeForKv.from(
      IntegerValueConverter.INTEGER, new IntegerValueConverter());
