...
public class BinaryValueConverter implements
  ...
  public static final DataType<byte[]> BLOB =
      new DefaultDataType<byte[]>(SQLDialect.MYSQL, SQLDataType.BLOB, "BLOB");

  public static final DataTypeForKv<KvBinary> TYPE = DataTypeForKv.from(
      BinaryValueConverter.BLOB, new BinaryValueConverter(), Types.LONGVARBINARY);
