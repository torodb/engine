...
public class MySqlMetaDataWriteInterface extends AbstractMetaDataWriteInterface {
  ...
  @Inject
  public MySqlMetaDataWriteInterface(MySqlMetaDataReadInterface metaDataReadInterface,
      SqlHelper sqlHelper) {
  ...
  protected String getCreateMetaDatabaseTableStatement(String schemaName, String tableName) {
    String statement = new MySqlBuilder("CREATE TABLE ").table(schemaName, tableName)
        .append(" (")
        .quote(MetaDatabaseTable.TableFields.NAME).append("       varchar(256)  PRIMARY KEY     ,")
        .quote(MetaDatabaseTable.TableFields.IDENTIFIER).append(" varchar(64)  NOT NULL UNIQUE ")
        .append(")")
        .toString();
    return statement;
  }
  ...
  protected String getCreateMetaCollectionTableStatement(String schemaName, String tableName) {
    String statement = new MySqlBuilder("CREATE TABLE ").table(schemaName, tableName)
        .append(" (")
        .quote(MetaCollectionTable.TableFields.DATABASE).append(" varchar(256)  NOT NULL        ,")
        .quote(MetaCollectionTable.TableFields.NAME).append("     varchar(256)  NOT NULL        ,")
        .quote(MetaCollectionTable.TableFields.IDENTIFIER).append(
  ...
  protected String getCreateMetaDocPartTableStatement(String schemaName, String tableName) {
    String statement = new MySqlBuilder("CREATE TABLE ").table(schemaName, tableName)
        .append(" (")
        .quote(MetaDocPartTable.TableFields.DATABASE).append("   varchar(256)   NOT NULL ,")
        .quote(MetaDocPartTable.TableFields.COLLECTION).append(" varchar(256)   NOT NULL ,")
        .quote(MetaDocPartTable.TableFields.TABLE_REF).append("  varchar(1512) NOT NULL ,")
        .quote(MetaDocPartTable.TableFields.IDENTIFIER).append(" varchar(64)   NOT NULL ,")
  ...
  protected String getCreateMetaFieldTableStatement(String schemaName, String tableName) {
    String statement = new MySqlBuilder("CREATE TABLE ").table(schemaName, tableName)
        .append(" (")
        .quote(MetaFieldTable.TableFields.DATABASE).append("   varchar(256)     NOT NULL ,")
        .quote(MetaFieldTable.TableFields.COLLECTION).append(" varchar(256)     NOT NULL ,")
        .quote(MetaFieldTable.TableFields.TABLE_REF).append("  varchar(1520)   NOT NULL ,")
        .quote(MetaFieldTable.TableFields.NAME).append("       varchar(512)     NOT NULL ,")
        .quote(MetaFieldTable.TableFields.TYPE).append("       varchar(32)     NOT NULL ,")
        .quote(MetaFieldTable.TableFields.IDENTIFIER).append(" varchar(64)     NOT NULL ,")
  ...
  protected String getCreateMetaScalarTableStatement(String schemaName, String tableName) {
    String statement = new MySqlBuilder("CREATE TABLE ").table(schemaName, tableName)
        .append(" (")
        .quote(MetaScalarTable.TableFields.DATABASE).append("   varchar(256)    NOT NULL ,")
        .quote(MetaScalarTable.TableFields.COLLECTION).append(" varchar(256)    NOT NULL ,")
        .quote(MetaScalarTable.TableFields.TABLE_REF).append("  varchar(1520)  NOT NULL ,")
        .quote(MetaScalarTable.TableFields.TYPE).append("       varchar(32)    NOT NULL ,")
        .quote(MetaScalarTable.TableFields.IDENTIFIER).append(" varchar(64)    NOT NULL ,")
  ...
  protected String getCreateMetaIndexTableStatement(String schemaName, String tableName) {
    String statement = new MySqlBuilder("CREATE TABLE ").table(schemaName, tableName)
        .append(" (")
        .quote(MetaIndexTable.TableFields.DATABASE).append(" varchar(256)  NOT NULL        ,")
        .quote(MetaIndexTable.TableFields.COLLECTION).append(" varchar(256)  NOT NULL        ,")
        .quote(MetaIndexTable.TableFields.NAME).append("     varchar(512)  NOT NULL        ,")
  ...
  protected String getCreateMetaIndexFieldTableStatement(String schemaName, String tableName) {
    String statement = new MySqlBuilder("CREATE TABLE ").table(schemaName, tableName)
        .append(" (")
        .quote(MetaIndexFieldTable.TableFields.DATABASE).append("   varchar(256)   NOT NULL ,")
        .quote(MetaIndexFieldTable.TableFields.COLLECTION).append(" varchar(256)   NOT NULL ,")
        .quote(MetaIndexFieldTable.TableFields.INDEX).append(" varchar(512)   NOT NULL ,")
        .quote(MetaIndexFieldTable.TableFields.POSITION).append(" integer   NOT NULL ,")
        .quote(MetaIndexFieldTable.TableFields.TABLE_REF).append("  varchar(1520) NOT NULL ,")
        .quote(MetaIndexFieldTable.TableFields.NAME).append(" varchar(512)   NOT NULL ,")
        .quote(MetaIndexFieldTable.TableFields.ORDERING).append("   varchar(4)   NOT NULL ,")
  ...
  protected String getCreateMetaDocPartIndexTableStatement(String schemaName, String tableName) {
    String statement = new MySqlBuilder("CREATE TABLE ").table(schemaName, tableName)
        .append(" (")
        .quote(MetaDocPartIndexTable.TableFields.DATABASE).append("   varchar(256)   NOT NULL ,")
        .quote(MetaDocPartIndexTable.TableFields.IDENTIFIER).append(" varchar(64)   NOT NULL ,")
        .quote(MetaDocPartIndexTable.TableFields.COLLECTION).append(" varchar(256)   NOT NULL ,")
        .quote(MetaDocPartIndexTable.TableFields.TABLE_REF).append("  varchar(1520) NOT NULL ,")
  ...
  protected String getCreateMetainfStatement(String schemaName, String tableName) {
    return new MySqlBuilder("CREATE TABLE ").table(schemaName, tableName)
        .append(" (")
        .quote(KvTable.TableFields.KEY).append(" varchar(256) NOT NULL, ")
        .quote(KvTable.TableFields.VALUE).append(" text NOT NULL,")
