...
public class StringValueConverter implements KvValueConverter<String, String, KvString> {
  ...
  public static final DataType<String>     TEXT               = 
      new DefaultDataType<String>(SQLDialect.MYSQL, SQLDataType.CLOB, "TEXT");
  
  public static final DataTypeForKv<KvString> TYPE = DataTypeForKv.from(
      StringValueConverter.TEXT, new StringValueConverter(), Types.LONGVARCHAR);
