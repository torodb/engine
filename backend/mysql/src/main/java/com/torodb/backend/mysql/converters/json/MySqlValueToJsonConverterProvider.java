...
package com.torodb.backend.mysql.converters.json;
...
import com.torodb.backend.mysql.converters.array.MySqlValueToArrayConverterProvider;
...
public class MySqlValueToJsonConverterProvider implements ValueToJsonConverterProvider {
  ...
  private MySqlValueToJsonConverterProvider() {
    ...
    converters.put(ArrayType.class, new ArrayValueToJsonConverter(
        MySqlValueToArrayConverterProvider.getInstance()));
