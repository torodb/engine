...
public class MySqlSnapshotUpdaterImpl extends SnapshotUpdaterImpl {

  @Inject
  public MySqlSnapshotUpdaterImpl(SqlInterface sqlInterface, SqlHelper sqlHelper,
      SchemaUpdater schemaUpdater, TableRefFactory tableRefFactory) {
    super(sqlInterface, sqlHelper, schemaUpdater, tableRefFactory);
  }

  @Override
  protected SnapshotUpdaterImpl.Updater createUpdater(DSLContext dsl) {
    return new Updater(dsl, tableRefFactory, sqlInterface);
  }

  protected static class Updater extends SnapshotUpdaterImpl.Updater {
