...
import com.torodb.backend.LazyBackendCursor;
 ...
 *
 */
abstract class BackendTransactionImpl implements DmlTransaction {
  ...
  public Optional<KvValue<?>> readMetaInfo(MetaInfoKey key) throws
    ...
    return metainfoHandler.readMetaInfo(getDsl(), key);
  }
