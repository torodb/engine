 ...
 *
 */
public class DocTransactionDecorator<T extends DocTransaction> implements DocTransaction {

  private final T decorated;

  public DocTransactionDecorator(T decorated) {
    this.decorated = decorated;
  }

  protected T getDecorated() {
    return decorated;
  }
