 ...
 *
 */
public class SchemaOperationException extends ToroRuntimeException {

  private static final long serialVersionUID = 5427812319947277L;
  ...
  public SchemaOperationException(Throwable cause) {
    super(cause);
  }
